...
export default function AdminCourses() {
  ...
  const handleDelete = (id: string, title: string) => {
    Alert.alert(
      "Delete Course",
      `Delete "${title}"? All enrollments and assignments will be lost.`,
      [
    ...
    >
      ...
      {filtered.length === 0 ? (
        ...
        filtered.map((course) => (
          ...
          >
            <View
              style={[styles.cardAccent, { backgroundColor: course.color }]}
            />
            <View style={styles.cardBody}>
              ...
              >
                <View style={styles.cardHeader}>
                  <View
                    style={[
                      ...
                      {
                        backgroundColor:
                          (CATEGORY_COLORS[course.category] ?? "#3B5BDB") +
                          "18",
                      },
                    ]}
                  >
                    <Text
                      style={[
                        styles.catText,
                        {
                          color: CATEGORY_COLORS[course.category] ?? "#3B5BDB",
                        },
                      ]}
                    >
                      {course.category}
                ...
                <Text
                  style={[styles.instructorName, { color: colors.primary }]}
                >
              ...
              >
                <View style={styles.publishRow}>
                  <Text
                    style={[styles.publishLabel, { color: colors.foreground }]}
                  >
