      ...
      [
        { text: "Cancel", style: "cancel" },
        {
          ...
          onPress: async () => {
            ...
            Alert.alert(
              "Reset Complete",
              "Data has been cleared. The app will restart.",
    ...
    >
      ...
      >
        ...
        <View style={styles.statsGrid}>
          {SYSTEM_STATS.map((stat) => (
            <View
              key={stat.label}
              style={[styles.statItem, { backgroundColor: stat.color + "12" }]}
            >
        ...
        {[
          {
            ...
            sub: "Students can enroll in new courses",
            value: allowEnrollment,
            setter: setAllowEnrollment,
            color: "#0CA678",
          },
          {
            label: "Maintenance Mode",
            sub: "Temporarily restrict access to the platform",
          ...
          },
          {
            ...
            sub: "Send notifications for assignments and grades",
        ...
        >
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={[styles.actionSub, { color: colors.mutedForeground }]}>
              Clear and restore to factory defaults
            </Text>
          </View>
          <Ionicons
      ...
      >
        ...
        <Text style={[styles.appVersion, { color: colors.mutedForeground }]}>
          Online Learning System v1.0.0
        </Text>
        <Text style={[styles.appCopy, { color: colors.mutedForeground }]}>
